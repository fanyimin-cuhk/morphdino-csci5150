...
#config = json.load(open('/mnt/data/aim/liyaxuan/projects/project2/ssl_neuron/ssl_neuron/configs/config_classification.json'))
config = json.load(open('/mnt/data/aim/liyaxuan/projects/project2/codebase/ssl_neuron/configs/config_classification.json'))
